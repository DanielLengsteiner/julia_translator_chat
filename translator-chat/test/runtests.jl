...
# !!! Main.UserApp is configured as an alias for Main.TranslatorChat and you might encounter it in some tests
using Main.TranslatorChat, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "TranslatorChat tests" begin
  @includetests ARGS
end
